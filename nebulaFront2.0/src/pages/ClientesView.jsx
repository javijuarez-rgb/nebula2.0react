              ...
              <div className="card h-100 border-0 shadow-sm" style={{ backgroundColor: 'var(--bg-card)', border: '1px solid var(--border-color)', transition: '0.3s' }}>
                <div className="card-body p-4 d-flex flex-column">
                  <div className="d-flex justify-content-between align-items-start mb-3">
                    ...
                    <span className={`badge rounded-pill px-3 py-2 ${cliente.es_activo ? 'bg-success-subtle text-success' : 'bg-secondary-subtle text-secondary'}`}>
                ...
                {cliente.es_potencial === 1 && (
                  <div className="p-2 px-3 rounded-3 mb-3 d-flex align-items-center gap-2 border-0" style={{ backgroundColor: 'rgba(255, 193, 7, 0.1)', color: '#ffc107' }}>
                    <BadgeCheck size={16} /> <span className="small fw-bold uppercase">Cliente Potencial</span>
                  </div>
                )}

                <div className="d-flex gap-2 mt-auto">
                  <button className="btn btn-sm btn-outline-primary flex-grow-1 fw-bold py-2">Editar</button>
                  <button className="btn btn-sm btn-outline-info flex-grow-1 fw-bold py-2">Estrategia</button>
                </div>
              </div>
            </div>
          </div>
